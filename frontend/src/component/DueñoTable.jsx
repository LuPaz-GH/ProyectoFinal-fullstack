...
import { faPencilAlt, faToggleOff } from '@fortawesome/free-solid-svg-icons';
          ...
          {dueños.map(d => (
            <tr key={d.id}>
              ...
              <td className="text-center">
                ...
                <button className="btn btn-danger btn-sm rounded-circle shadow-sm" title="Desactivar" style={{ width: '35px', height: '35px' }} onClick={() => onEliminar(d.id)}>
