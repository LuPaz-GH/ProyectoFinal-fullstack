...
import {
    ...
    faCheckCircle, faToggleOff, faEyeSlash
...
const PetshopPage = () => {
    ...
    const exportarExcel = async () => {
        await exportarExcelEstilizado({
            ...
            filename: 'Stock_Petshop_Malfi.xlsx',
            sheetName: 'Petshop',
            headerColor: '16A085'
        });
    };
    ...
    return (
        <div className="container-fluid min-vh-100 p-4 position-relative" style={{
                                    ...
                                    >
                                        ...
                                        <div className="d-flex justify-content-between align-items-center mt-auto">
                                            ...
                                            <div className="d-flex gap-1">
                                                ...
                                                <button className="btn btn-sm btn-outline-danger rounded-circle shadow-sm bg-white" title="Desactivar" onClick={(e) => { e.stopPropagation(); setIdToDelete(p.id); setShowConfirm(true); }}><FontAwesomeIcon icon={faToggleOff} /></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <ConfirmModal
                ...
                title="¿Desactivar este producto?" message="Se moverá a Inactivos y podrás restaurarlo más tarde."
