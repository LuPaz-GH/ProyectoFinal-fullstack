                                            ...
                                            <td className="text-end pe-4">
                                                {editando === s.id ? (
                                                    ...
                                                    <div className="d-flex gap-2 justify-content-end align-items-center">
                                                        ...
                                                        <button className="btn btn-outline-danger btn-sm rounded-circle d-flex align-items-center justify-content-center" title="Desactivar" style={{width:'32px', height:'32px'}} onClick={() => solicitarMoverAPapelera(s)}>
                                                            <FontAwesomeIcon icon={faToggleOff} size="xs" />
                                                        </button>
                                                    </div>
                                                )}
                                            </td>
                    ...
                    <div className="modal-dialog modal-dialog-centered modal-sm" style={{maxWidth: '350px'}}>
                        <div className="modal-content border-0 rounded-4 shadow-lg text-center overflow-hidden">
                            <div className="p-4">
                                ...
                                <p className="text-muted small mb-0">¿Desactivar el servicio <strong className="text-dark">"{confirmModal.servicio?.nombre}"</strong>? Se moverá a Inactivos.</p>
                            </div>
                            <div className="d-flex border-top">
                                ...
                                <button className="btn btn-danger w-50 rounded-0 py-3 fw-bold shadow-none" onClick={confirmarMoverAPapelera}>Sí, desactivar</button>
                            </div>
                        </div>
                    </div>
                </div>
