...
const EsteticaPage = () => {
    ...
    const exportarExcel = async () => {
        await exportarExcelEstilizado({
            data: obtenerTurnosFiltradosYOrdenados().map(s => ({
                fecha: s.fecha,
                hora: s.hora,
                mascota: s.mascota,
                dueno: s.dueno,
            ...
            filename: 'Agenda_Peluqueria_Malfi.xlsx',
            sheetName: 'Peluquería',
            headerColor: 'E84393'
        });
    };
        ...
        <div className="min-vh-100 p-4" style={{
            ...
            <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                                        ...
                                        <div className="col-md-6 col-lg-3" key={s.id}>
                                            <div className="card border-0 shadow-lg p-3 rounded-4 transition-card" style={{ background: 'rgba(255, 255, 255, 0.95)' }}>
                                                ...
                                                <div className="d-flex gap-2">
                                                    ...
                                                    <button className="btn btn-light btn-sm rounded-circle border shadow-sm text-danger" title="Desactivar" onClick={() => setConfirmacion({ show: true, id: s.id, nombreMascota: s.mascota })}><FontAwesomeIcon icon={faToggleOff}/></button>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
                ...
                <ConfirmModal 
                    ...
                    title={`¿Desactivar turno de ${confirmacion.nombreMascota}?`}
