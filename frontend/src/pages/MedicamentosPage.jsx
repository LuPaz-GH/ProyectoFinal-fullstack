...
import {
    ...
    faTrashAlt, faHistory, faTrashRestore, faCheckCircle, faToggleOff, faEyeSlash
...
const MedicamentosPage = () => {
    ...
    const exportarExcel = async () => {
        await exportarExcelEstilizado({
            ...
            filename: 'Stock_Medicamentos_Malfi.xlsx',
    ...
    return (
        <div className="container-fluid min-vh-100 p-4 position-relative" style={{
                                            ...
                                            <div className="card border-0 shadow-sm p-3 rounded-4 h-100 border-start border-4 border-primary"
                                                ...
                                                <div className="d-flex justify-content-between align-items-center mt-auto">
                                                    ...
                                                    <div className="d-flex gap-1">
                                                        ...
                                                        <button className="btn btn-sm btn-outline-danger rounded-circle bg-white" title="Desactivar" onClick={() => { setIdToDelete(m.id); setShowConfirm(true); }}>
            ...
            <ConfirmModal
                ...
                title="¿Desactivar este medicamento?" message="Se moverá a Inactivos y podrás restaurarlo más tarde."
