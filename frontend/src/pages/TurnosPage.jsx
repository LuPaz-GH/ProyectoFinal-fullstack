...
import {
    ...
    faChevronLeft, faChevronRight, faHistory, faArrowLeft, faAmbulance, faExclamationTriangle, faUserMd, faRandom, faHourglassStart, faToggleOff, faEyeSlash
...
const TurnosPage = ({ user }) => {
    ...
    const exportarExcel = async () => {
        await exportarExcelEstilizado({
            ...
            filename: `Agenda_Turnos_Malfi.xlsx`,
            sheetName: 'Turnos',
            headerColor: '546E7A'
        });
    };
        ...
        <div className="min-vh-100 p-4 p-md-5" style={{ backgroundImage: `url('https://i.pinimg.com/1200x/0f/72/c3/0f72c33debe887dd051042d7642024b0.jpg')`, backgroundSize: 'cover', backgroundAttachment: 'fixed', backgroundPosition: 'center' }}>
            <div className="position-relative z-1">
                ...
                <div className="mb-5 d-flex gap-3 align-items-center flex-wrap">
                    ...
                    >
                        <FontAwesomeIcon icon={faEyeSlash} /> Inactivos
                    </button>
                </div>
                                            ...
                                            <div className="col-md-6 col-lg-3" key={t.id}>
                                                <div className={`card border-0 shadow-lg p-3 rounded-4 ${t.es_urgencia ? 'border-start border-danger border-5' : ''}`} style={{ background: 'rgba(255, 255, 255, 0.95)' }}>
                                                    ...
                                                    <div className="d-flex gap-2">
                                                        ...
                                                        <button className="btn btn-white btn-sm rounded-circle border shadow-sm" title="Desactivar" onClick={() => { setIdToDelete(t.id); setShowConfirm(true); }}><FontAwesomeIcon icon={faToggleOff} className="text-danger" /></button>
                                                    </div>
                                                </div>
                                            </div>
                                        ))}
            ...
            <ConfirmModal
                ...
                title="¿Desactivar este turno?"
                message="Se moverá a Inactivos y podrás restaurarlo más tarde."
