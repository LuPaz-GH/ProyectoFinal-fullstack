                ...
                paginatedDuenos.map((dueno) => (
                  <tr key={dueno.id}>
                    ...
                    <td className="text-center">
                      ...
                      <button className="btn btn-white btn-sm rounded-circle shadow-sm text-danger border" onClick={() => { setIdAEliminar(dueno.id); setShowConfirm(true); }} title="Desactivar">
