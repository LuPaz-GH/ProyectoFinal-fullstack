            ...
            <div className="col-md-3" key={m.id}>
              ...
              >
                ...
                <div className="d-flex justify-content-center gap-2 mt-auto">
                  ...
                  <button className="btn btn-sm btn-outline-danger rounded-circle shadow-sm" title="Desactivar" onClick={(e) => { e.stopPropagation(); setIdEliminar(m.id); setShowConfirmModal(true); }}><FontAwesomeIcon icon={faToggleOff} /></button>
                </div>
              </div>
            </div>
          ))}
