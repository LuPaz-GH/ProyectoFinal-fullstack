...
import {
  ...
  faTrashRestore, faAmbulance, faToggleOff, faEyeSlash
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content border-0 shadow-lg rounded-4">
              <div className="modal-body text-center p-5">
                ...
                <h4 className="fw-bold">¿Desactivar este registro?</h4>
                <p className="text-muted">Se moverá a Inactivos y podrás restaurarlo más tarde.</p>
                ...
                <div className="d-flex gap-2 justify-content-center">
                    ...
                    <button className="btn btn-warning text-dark px-4 rounded-pill fw-bold" onClick={confirmarBorrar}>Sí, desactivar</button>
                </div>
              </div>
            </div>
          </div>
